...
// Load env (simple hack for script)
const SUPABASE_URL = 'https://vmibnrdpbliwdpfqhlfw.supabase.co';
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZtaWJucmRwYmxpd2RwZnFobGZ3Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NjY2OTIxNSwiZXhwIjoyMDgyMjQ1MjE1fQ.DIb5oVh0FYAnZLbdQx1iBvEZZYMXEixieevyHFsB_Uw'; // Service Role Key from previous tool output
...
async function seedData() {
  ...
  // 1. Create Dummy Excel File (Simulating User Upload)
  const users = [
